...
public class Grow {
    ...
    public void before() throws Exception{
        ExtentSparkReporter exsprk = new ExtentSparkReporter("D:\\Software Testing\\Day 9\\sec1report\\report1.html");
    ...
    public void test1() throws Exception{
        ...
        FileInputStream fs = new FileInputStream("D:\\Software Testing\\Day 9\\sec1excel.xlsx");
    ...
    public void afterTest(ITestResult result) throws Exception{
        if(result.getStatus()==ITestResult.FAILURE)
        {
            ...
            String path = "D:\\Software Testing\\Day 9\\"+result.getName()+"png";
